  ...
  return (
    <div>
      ...
      <div className="p-3 space-y-3 mt-3">
        ...
        <div>
          <a href="" className="flex items-center p-4 gap-3 text-lg font-medium border rounded-t-lg">
            <h2 className="bg-gray-100 p-2 rounded-full">
              <FaFacebookF />
            </h2>
            Facebook
          </a>
          <a href="" className="flex items-center p-4 gap-3 text-lg font-medium border-x">
            <h2 className="bg-gray-100 p-2 rounded-full">
              <FaTwitter />
            </h2>
            Twitter
          </a>
          <a href="" className="flex items-center p-4 gap-3 text-lg font-medium border rounded-b-lg">
            <h2 className="bg-gray-100 p-2 rounded-full">
              <FaInstagram />
            </h2>
            Instagram
